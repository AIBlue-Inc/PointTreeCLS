...
class NifosTreeFinalGomsolTest(Dataset):
    def __init__(self, config):
        ...
        self.cat = ['Densi', 'gul', 'Koraiensis', 'Larix', 'obtusa', 'sang', 'sin', 'thunbergii']
    ...
    def __getitem__(self, index):
        ...
        return 'NifosTreeFinalGomsolTest', 'sample', (current_points, label, file)