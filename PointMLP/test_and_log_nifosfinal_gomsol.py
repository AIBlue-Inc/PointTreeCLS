...
from data_nifosfinal_gomsol import NifosTreeFinalGomsol as NifosTreeFinal
...
# python test_and_log_nifosfinal_gomsol.py --model pointMLP --num_points 1024 --batch_size 32 --checkpoint "checkpoints/pointmlp-20241009054729-1"
# python test_and_log_nifosfinal_gomsol.py --model pointMLP --num_points 2048 --batch_size 32 --checkpoint "checkpoints/pointmlp-20241009073521-1"
# python test_and_log_nifosfinal_gomsol.py --model pointMLP --num_points 2048 --batch_size 16 --checkpoint "checkpoints/pointmlp-20241009031205-1"
# python test_and_log_nifosfinal_gomsol.py --model pointMLP --num_points 1024 --batch_size 16 --checkpoint "checkpoints/pointmlp-20241009003937-1"