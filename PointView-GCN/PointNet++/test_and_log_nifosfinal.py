...
def main(args):
    ...
    valid_path = f'../../data/240916_total_{args.num_point}_xyz/*/valid'
    test_path = f'../../data/240916_total_{args.num_point}_xyz/*/test'
...
# python test_and_log_nifosfinal.py --model POINTNET_MSG_CLS --num_point 2048 --batch_size 32 --log_dir log/classification/2024-09-20_23-34 --num_votes 3
# python test_and_log_nifosfinal.py --model POINTNET_MSG_CLS --num_point 2048 --batch_size 16 --log_dir log/classification/2024-09-20_20-33 --num_votes 3
# python test_and_log_nifosfinal.py --model POINTNET_MSG_CLS --num_point 1024 --batch_size 32 --log_dir log/classification/2024-09-20_18-51 --num_votes 3
# python test_and_log_nifosfinal.py --model POINTNET_MSG_CLS --num_point 1024 --batch_size 16 --log_dir log/classification/2024-09-20_16-35 --num_votes 3