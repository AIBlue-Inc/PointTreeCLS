...
def main(args):
    ...
    wandb.run.name = f"test-PointNet2-{args.num_point}-{args.batch_size}"

    # Load dataset
    log_string('Load dataset ...')
    valid_path = f'../../data/241008_total_{args.num_point}_xyz/*/valid'
    test_path = f'../../data/241008_total_{args.num_point}_xyz/*/test'

    VALID_DATASET = SinglePointFinal(valid_path, npoint=args.num_point)
...
# python test_and_log_nifosfinal_gomsol.py --model POINTNET_MSG_CLS --num_point 2048 --batch_size 32 --log_dir log/classification/2024-10-09_20-25 --num_votes 3
# python test_and_log_nifosfinal_gomsol.py --model POINTNET_MSG_CLS --num_point 2048 --batch_size 16 --log_dir log/classification/2024-10-09_17-29 --num_votes 3
# python test_and_log_nifosfinal_gomsol.py --model POINTNET_MSG_CLS --num_point 1024 --batch_size 32 --log_dir log/classification/2024-10-09_15-48 --num_votes 3
# python test_and_log_nifosfinal_gomsol.py --model POINTNET_MSG_CLS --num_point 1024 --batch_size 16 --log_dir log/classification/2024-10-09_13-35 --num_votes 3